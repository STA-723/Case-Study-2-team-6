...
We compare the effect of the different given and computed features of the dataset using a log-linear regression. With the log of our normalized monthly number of reviews as a popularity response, we focus on the effects of distance to subway station, of listing price, of number of months active, of host gender, of room type, and of the the keywords identified in the text analysis, while controlling for neighborhood effects.
