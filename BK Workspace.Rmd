...
data %>% 
  ...
  select(number_of_reviews, last_review, months_active, reviews_per_month, nrml_avg_reviews)
...
model <- lmer(nrml_avg_reviews~ (1|neighbourhood_group/neighbourhood), data = data)
